...
export default function Offers()  {
    return (
      ...
      <h4 className="text-primary text-3xl font-semibold">Rent without fret- worry free payments</h4>
      <p className="text-service font-normal">Our offerings are custom-made to fit your lifestyle and cater to your needs!</p>
      </div>
